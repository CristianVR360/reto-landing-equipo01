# Frontend Mentor - Página de aterrizaje de Huddle con solución de secciones curvas

Esta es una solución al [desafío de la página de aterrizaje de Huddle con secciones curvas en Frontend Mentor](https://www.frontendmentor.io/challenges/huddle-landing-page-with-curved-sections-5ca5ecd01e82137ec91a50f2). Los desafíos de Frontend Mentor lo ayudan a mejorar sus habilidades de codificación mediante la creación de proyectos realistas.
